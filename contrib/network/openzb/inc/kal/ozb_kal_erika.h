...
COMPILER_INLINE int8_t ozb_kal_erika_cancel_activation(AlarmType aid) 
{
	CancelAlarm(aid);
	return 1;
}
...
COMPILER_INLINE int8_t ozb_kal_erika_init(uint32_t tick_duration) 
{
...
COMPILER_INLINE int8_t ozb_kal_erika_mutex_wait(ResourceType res) 
{
	GetResource(res);
	return 1;
}

COMPILER_INLINE int8_t ozb_kal_erika_mutex_signal(ResourceType res) 
{
	ReleaseResource(res);
	return 1;
}
