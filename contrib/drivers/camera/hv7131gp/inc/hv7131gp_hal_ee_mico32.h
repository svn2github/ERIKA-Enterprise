...
__INLINE__ void __ALWAYS_INLINE__ Mico_camera_write_address(MicoCamera_t* cam, void* address)
{
    cam->addr = address;
}
...
__INLINE__ void __ALWAYS_INLINE__ Mico_camera_enable_IRQ(MicoCamera_t* cam)
{
    cam->cntr2 = MICO_CAM_ENABLE_IRQ_MASK;
}

__INLINE__ void __ALWAYS_INLINE__ Mico_camera_disable_IRQ(MicoCamera_t* cam)
{
    cam->cntr2 = 0;
}
...
__INLINE__ void __ALWAYS_INLINE__ Mico_camera_write_divisor(MicoCamera_t* cam, int divisor)
{
    cam->div = divisor;
}
