 ...
 **************************************************************************/
    ...
    int EE_s12xs_stack_1[STACK_1_SIZE];	/* Task 1 (Producer) */
    int EE_s12xs_stack_2[STACK_2_SIZE];	/* Task 2 (Consumer) */
    ...
    struct EE_TOS EE_s12xs_system_tos[3] = {
        {0},	/* Task   (dummy) */
        {(EE_DADD)(&EE_s12xs_stack_1[STACK_1_SIZE-1])},	/* Task 1 (Producer) */
        {(EE_DADD)(&EE_s12xs_stack_2[STACK_2_SIZE-1])} 	/* Task 2 (Consumer) */
    };
