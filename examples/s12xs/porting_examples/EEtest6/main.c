...
//extern EE_UINT16 EE_terminate_data[EE_MAX_TASK];
//extern const EE_ADDR EE_terminate_real_th_body[EE_MAX_TASK];
...
//	*sp = _asm("tfr x,d");
//	(*((void (*)(void))realbody))(); 
//	//EE_s12xs_terminate_task(sp);
//	return;
//}
//
//
//void EE_s12xs_terminate_task(EE_DADD sp)
//{
//	_asm("tfr d,s",*sp);
//    return;	
//}
