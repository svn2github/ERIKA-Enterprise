...
float 	 scicosOpenZB_rx_buffer[SCICOS_OPENZB_CHANNELS];

void scicosOpenZB_rx_callback(OpenZB_ExitStatus code,  EE_UINT8* data, EE_UINT16 size)
{
  static int pippo;

	EE_INT16 ch;
	ScicosOpenZB_Payload *packet = (ScicosOpenZB_Payload*) data;
