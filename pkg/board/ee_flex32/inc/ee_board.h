...
#ifndef __INCLUDE_EE_FLEX32_BOARD_H__
#define __INCLUDE_EE_FLEX32_BOARD_H__
...
__INLINE__ void __ALWAYS_INLINE__ EE_led_sys_on(void)      { LATBSET = 0x4000; }
__INLINE__ void __ALWAYS_INLINE__ EE_led_sys_off(void)     { LATBCLR = 0x4000; }
__INLINE__ void __ALWAYS_INLINE__ EE_led_sys_toggle(void)  { LATBINV = 0x4000; }

__INLINE__ void __ALWAYS_INLINE__ EE_led_on(void)      { LATBSET = 0x4000; }
__INLINE__ void __ALWAYS_INLINE__ EE_led_off(void)     { LATBCLR = 0x4000; }
__INLINE__ void __ALWAYS_INLINE__ EE_led_toggle(void)  { LATBINV = 0x4000; }
...
#include "board/ee_flex32/inc/ee_flex32_demoboard.h"
...
#include "board/ee_flex32/inc/ee_flex32_motionboard.h"
