...
static void EE_tc_isr2_global_wrapper(EE_tc_ISR_handler f);

#ifdef __TASKING__

/* With tasking I can generate the Intrrupt vector and the
...
#ifdef __GNUC__
static void __attribute__((interrupt_handler, used))
#elif defined(__TASKING__)
