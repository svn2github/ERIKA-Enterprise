 ...
 * CVS: $Id: ee_kernel.h,v 1.1 2008/04/23 11:36:01 francesco Exp $
 */

#include "kernel/IRIS/inc/ee_common.h"

#ifndef __INCLUDE_IRIS_KERN_H__
#define __INCLUDE_IRIS_KERN_H__
...
void EE_iris_sys_scheduler(void);
#endif

#ifndef __PRIVATE_SYS_GETTIME__
#ifdef __TIME_SUPPORT__
EE_TIME EE_iris_sys_gettime(void);
#endif
#endif
...
/* This primitive activates a thread once and then execute the
   preemption test */
void EE_iris_thread_activate(EE_TID t);
#endif
