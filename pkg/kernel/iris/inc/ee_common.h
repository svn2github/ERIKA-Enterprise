 ...
 * CVS: $Id: ee_common.h,v 1.1 2008/04/23 11:36:01 francesco Exp $
 */

#ifndef __INCLUDE_IRIS_COMMON_H__
#define __INCLUDE_IRIS_COMMON_H__
...
extern const EE_TYPERELDLINE EE_inv_proc_util[];     /* inverse processor utilization */
