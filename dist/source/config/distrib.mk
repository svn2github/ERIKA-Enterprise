...
distrib_opt___DRIVERS__:: \
		...
		ee_$(DIST)/contrib/drivers/touch/inc/touch_kal.h \
		ee_$(DIST)/contrib/drivers/touch/inc/touch_kal_erika.h \
		ee_$(DIST)/contrib/drivers/touch/inc/touch_timer.h \
		ee_$(DIST)/contrib/drivers/touch/inc/touch_timer_dspic30.h \
		ee_$(DIST)/contrib/drivers/touch/src \
		ee_$(DIST)/contrib/drivers/touch/src/touch.c \
		ee_$(DIST)/contrib/drivers/touch/src/touch_kal_erika.c \
		ee_$(DIST)/contrib/drivers/touch/src/touch_timer_dspic30.c 

distrib_opt___AMAZING__:: \
		ee_$(DIST)/contrib/amazing/ \
		ee_$(DIST)/contrib/amazing/cfg \
		ee_$(DIST)/contrib/amazing/cfg/cfg.mk \
		ee_$(DIST)/contrib/amazing/cfg/libcfg.mk \
		ee_$(DIST)/contrib/amazing/inc \
		ee_$(DIST)/contrib/amazing/inc/amazing.h \
		ee_$(DIST)/contrib/amazing/src \
		ee_$(DIST)/contrib/amazing/src/amazing.c
...
distrib_opt___SCICOS__:: \
		...
		ee_$(DIST)/contrib/scicos/src/pic30/amazing_button.c \
		ee_$(DIST)/contrib/scicos/src/pic30/amazing_pwm.c \
		ee_$(DIST)/contrib/scicos/src/pic30/amazing_reset.c \
		ee_$(DIST)/contrib/scicos/src/pic30/amazing_touch.c \
		ee_$(DIST)/contrib/scicos/src/pic30/amazing_tuner.c \
		...
		ee_$(DIST)/contrib/scicos/src/pic30/flex_daughter_leds_barrier.c \
