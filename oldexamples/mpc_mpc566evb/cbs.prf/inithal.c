...
extern ERIKA_TIME tprecapacity,tpostendcycle ;
void capacity_handler(void) {  if (!tpostendcycle) tprecapacity = ERIKA_timer_0_get(); }
ERIKA_ADDR ERIKA_timer1_handler_addr = (ERIKA_ADDR)capacity_handler;
#endif
